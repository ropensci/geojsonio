...
#' @param var (character) A single variable to map colors, symbols,
#' and/or sizes to
...
#' @param var_stroke_width (character) A single variable to map stroke
#' width to.
#' @param var_stroke_opacity (character) A single variable to map stroke
#' opacity to.
...
#' to the variable `marker-size`
#' @param stroke (character) Color of a polygon edge or line (RGB). Assigned
#' to the variable `stroke`
#' @param stroke_width (numeric) Width of a polygon edge or line (number > 0).
#' Assigned  to the variable `stroke-width`
#' @param stroke_opacity (numeric) Opacity of a polygon edge or line
#' (0.0 - 1.0). Assigned to the variable `stroke-opacity`
#' @param fill (character) The color of the interior of a polygon (GRB).
#' Assigned to the variable `fill`
#' @param fill_opacity (character) The opacity of the interior of a polygon
#' (0.0-1.0). Assigned to the variable `fill-opacity`
#'
#' @details The parameters color, symbol, size, stroke, stroke_width,

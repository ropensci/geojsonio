test_that("geojson_list works with numeric inputs", {
  ...
  expect_equal(
    ...
    structure(list(type = "FeatureCollection", features = list(structure(list(
      type = "Feature", geometry = structure(list(
        type = "Point",
        coordinates = c(-99.74, 32.45)
  ...
  expect_equal(
    ...
    structure(list(type = "GeometryCollection", geometries = list(
      structure(list(type = "Point", coordinates = c(-99.74, 32.45)), .Names = c("type", "coordinates"))
    )), .Names = c(
      "type",
      "geometries"
    ), from = "numeric")
  ...
  expect_equal(
    ...
    structure(list(type = "FeatureCollection", features = list(structure(list(
      type = "Feature", geometry = structure(list(
        type = "Polygon",
        coordinates = list(list(c(-114.345703125, 39.4361929993141), c(-114.345703125, 43.4529188935547), c(
          -106.611328125,
          43.4529188935547
        ), c(-106.611328125, 39.4361929993141), c(-114.345703125, 39.4361929993141)))
      ), .Names = c(
        "type",
        "coordinates"
      )), properties = NULL
  ...
  expect_equal(
    ...
    structure(list(type = "FeatureCollection", features = list(structure(list(
      type = "Feature", geometry = structure(list(
        type = "Point",
        coordinates = c(-99.74, 32.45)
      ), .Names = c("type", "coordinates")), properties = structure(list(
        name = "Abilene TX", country.etc = "TX",
        pop = "113888", capital = "0"
      ), .Names = c(
        "name", "country.etc",
        "pop", "capital"
      ))
    ), .Names = c("type", "geometry", "properties")), structure(list(type = "Feature", geometry = structure(list(
      type = "Point", coordinates = c(-81.52, 41.08)
    ), .Names = c(
      "type",
      "coordinates"
    )), properties = structure(list(
      name = "Akron OH",
      country.etc = "OH", pop = "206634", capital = "0"
    ), .Names = c(
      "name",
      "country.etc", "pop", "capital"
    ))), .Names = c(
      "type", "geometry",
      "properties"
    )))), .Names = c("type", "features"), from = "data.frame")
  )
...
test_that("geojson_list works with data.frame inputs", {
  ...
  expect_equal(
    ...
    structure(list(type = "FeatureCollection", features = list(structure(list(
      type = "Feature", geometry = structure(list(
        type = "Point",
        coordinates = c(120, 30)
      ), .Names = c("type", "coordinates")), properties = structure(list(marker = "red"), .Names = "marker")
    ), .Names = c(
      "type",
      "geometry", "properties"
    )), structure(list(
      type = "Feature",
      geometry = structure(list(type = "Point", coordinates = c(
        130,
        30
      )), .Names = c("type", "coordinates")), properties = structure(list(
        marker = "blue"
      ...
      "type",
      "geometry", "properties"
    )))), .Names = c("type", "features"), from = "list")
  )
})
...
test_that("geojson_list works with data.frame inputs", {
  ...
  expect_equal(
    tmp,
    structure(list(type = "FeatureCollection", features = list(
      list(
      ...
      list(
        type = "Feature", properties = list(dat = 2L),
        geometry = list(type = "Point", coordinates = c(2, 2))
      ),
      list(
        type = "Feature", properties = list(dat = 3L),
        geometry = list(type = "Point", coordinates = c(3, 5))
      ),
      list(
        type = "Feature", properties = list(dat = 4L),
        geometry = list(type = "Point", coordinates = c(4, 1))
      ),
      list(
        type = "Feature", properties = list(dat = 5L),
